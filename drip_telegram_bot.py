...
- /volume: DRIP LP pairs sorted by 24H volume (descending), medals for top 3, 💰 for others, summary with SOL/DRIP (raydium).
- /ratio: DRIP LP pairs sorted by performance ratio (24H Volume ÷ Liquidity).
